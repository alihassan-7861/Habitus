...
//         minArea: 1,
//         minColors: 0,         // ✅ allow 0
//         maxColors: 256        // ✅ correct upper limit
// },
...
//    validate(data) {
//         const errors = [];
//         if (!Utils.validateNumber(data.width, this.rules.minWidth)) 
//             errors.push(`Width must be at least ${this.rules.minWidth}`);
//         if (!Utils.validateNumber(data.height, this.rules.minHeight)) 
//             errors.push(`Height must be at least ${this.rules.minHeight}`);
...
//                         valid = false;
//                         message = `Max colors must be between ${rules.minColors} and ${rules.maxColors}`;
//                     }
//                     break;
...
//         { id: 'maxColors', min: CONFIG.validation.minColors, max: CONFIG.validation.maxColors }  // ✅ min: 0, max: 256
//     ];
